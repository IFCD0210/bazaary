...
- [x] Comprobar la correcta instalación de paquetes en Sublime
- [ ] Primeros pasos en aplicaciones de cónsola básicas: _--help_, _whereis_, _apt-get_, _less_ y _man_
